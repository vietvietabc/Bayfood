...
from app.api import thucdon, datban, donhang, auth, nguoidung, danhmuc, ban, danhgia, upload, thongbao, giolamviec, payment, ws_thongbao, chatbot, livechat
...
_cors_origins = [
    "http://localhost:5173",
    "http://localhost:3000",
    "https://bayfood-chi.vercel.app",
    "https://bayfood-ja8ar427w-tran-dinh-viet-s-projects.vercel.app",
    "https://bayfood.vercel.app",
]

# Hỗ trợ thêm origin từ biến môi trường (cách nhau bởi dấu phẩy)
