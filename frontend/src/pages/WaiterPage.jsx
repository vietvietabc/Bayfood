...
const StatusBadge = ({ status }) => {
  ...
  return (
    <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem', padding: '0.25rem 0.65rem', borderRadius: '999px', background: s.bg, border: `1px solid ${s.border}`, color: s.color, fontSize: '0.75rem', fontWeight: '700' }}>
...
const WaiterPage = () => {
  ...
  if (authLoading) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: '42px', height: '42px', border: '4px solid var(--border)', borderTopColor: '#10b981', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
    </div>
  );
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--background)' }}>
      {/* Sub-header */}
      <div style={{ background: 'rgba(10,20,15,0.92)', borderBottom: '1px solid rgba(16,185,129,0.18)', padding: '0.6rem 2rem', position: 'sticky', top: '60px', zIndex: 40, backdropFilter: 'blur(8px)' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.75rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              {shiftData.trangThai === 'Đang làm' ? (
                ...
                <>
                  ...
                  <button onClick={handleShiftCheckIn} disabled={shiftLoading} style={{ padding: '0.3rem 0.75rem', borderRadius: '999px', border: '1px solid rgba(16,185,129,0.5)', background: 'rgba(16,185,129,0.15)', color: '#34d399', fontSize: '0.78rem', fontWeight: '700', cursor: 'pointer' }}>
                    Vào Ca
                  </button>
                </>
              )}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
            <div style={{ padding: '0.3rem 0.75rem', borderRadius: '999px', background: 'rgba(234,179,8,0.15)', border: '1px solid rgba(234,179,8,0.3)', color: '#fbbf24', fontSize: '0.78rem', fontWeight: '700' }}>{waitingCount} chờ món</div>
            <div style={{ padding: '0.3rem 0.75rem', borderRadius: '999px', background: 'rgba(249,115,22,0.15)', border: '1px solid rgba(249,115,22,0.3)', color: '#fb923c', fontSize: '0.78rem', fontWeight: '700' }}>{cookingCount} đang nấu</div>
            <div style={{ padding: '0.3rem 0.75rem', borderRadius: '999px', background: 'rgba(16,185,129,0.15)', border: '1px solid rgba(16,185,129,0.3)', color: '#34d399', fontSize: '0.78rem', fontWeight: '700' }}>{readyCount} sẵn sàng</div>
            ...
            <button onClick={fetchOrders} style={{ padding: '0.3rem 0.75rem', borderRadius: '999px', border: '1px solid rgba(16,185,129,0.4)', background: 'rgba(16,185,129,0.12)', color: '#34d399', fontSize: '0.75rem', fontWeight: '700', cursor: 'pointer' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem' }}>
          {[
            ...
            <button key={tab.key} onClick={() => {
              ...
              style={{ padding: '0.55rem 1.4rem', borderRadius: '999px', border: activeTab === tab.key ? '1px solid rgba(16,185,129,0.5)' : '1px solid var(--border)', background: activeTab === tab.key ? 'linear-gradient(135deg, #10b981, #059669)' : 'var(--surface)', color: activeTab === tab.key ? '#fff' : 'var(--text-muted)', fontWeight: '700', fontSize: '0.875rem', cursor: 'pointer', transition: 'all 0.2s', boxShadow: activeTab === tab.key ? '0 4px 14px rgba(16,185,129,0.3)' : 'none' }}>
              {tab.label}
            </button>
          ))}
        </div>
        ...
        {activeTab === 'shifts' && (
          personalShiftsLoading ? (
            ...
            <div style={{ textAlign: 'center', padding: '5rem 2rem', borderRadius: '1.25rem', border: '2px dashed var(--border)', background: 'var(--surface)' }}>
              ...
              <p style={{ color: 'var(--text-muted)', margin: 0 }}>Lịch sử check-in và tan ca của bạn sẽ được lưu ở đây.</p>
            </div>
          ) : (
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', minWidth: '600px' }}>
                  ...
                  <tbody>
                    {personalShifts.map(s => (
                      <tr key={s.id} style={{ borderBottom: '1px solid var(--border)', transition: 'background 0.2s', ':hover': { background: 'rgba(255,255,255,0.01)' } }}>
                        ...
                        <td style={{ padding: '1.1rem 1.5rem' }}>
                          {s.thoiGianRa === 'Chưa tan ca' ? (
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem', padding: '0.25rem 0.65rem', borderRadius: '999px', background: 'rgba(16,185,129,0.15)', border: '1px solid rgba(16,185,129,0.35)', color: '#34d399', fontSize: '0.75rem', fontWeight: '700' }}>
